...
This is currently a frontend-only project. The menu is informational, and the Order Now link takes visitors to the contact section. A real order form, online payments, or database-backed reservations would require a backend service.
